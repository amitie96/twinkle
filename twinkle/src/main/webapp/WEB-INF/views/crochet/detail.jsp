...
<body>
    ...
    <div class="content">
        ...
        <div class="image-container">
            <img src="/upload/crochet/${crochet.croUuid}_${crochet.croFilename}" alt="Image">
        </div>

        <!-- 텍스트 내용 오른쪽에 위치 -->
        <div class="text-container">
            <h1>${crochet.croTitle}</h1>

            <div class="info">
                <span><strong>난이도:</strong><a style="color: #f5a623;"> ${crochet.croRate}</a></span>
                <span><strong>작성자:</strong> ${crochet.nickname}</span>
                <span><strong>작성일:</strong> ${crochet.croDate}</span>
            </div>
	...
	<div class="button">
    	<a href="/crochet/list" class="back-button">목록</a>
    </div>
