    ...
    <div class="container">
        ...
        <h1>코바늘 도안 공유하기</h1>
            <div class="input-container">
                ...
                <input type="text" id="croTitle" name="croTitle" class="input-block" placeholder="제목을 입력하세요" autofocus required>
            </div>
            ...
            <div class="writing-block">
                ...
                <textarea id="croContent" name="croContent" class="input-block" placeholder="내용을 입력하세요" rows="10"></textarea>
            </div>
